  ...
  <div id="success" class="container" >
    ...
    <div class="col-md-4 col-centered">
         <div class="card mb-4 text-white bg-dark" style="border:none;">
            <img class="card-img-top" src="./img/CocoExit.jpeg" alt="Card image cap">
            <div class="card-body" align="center" style="background:white;">
               <h5 class="card-title" align="center" style="color:black">Byeee!</h5>
               <p class="card-text" align="center" style="color:black">You have logged out successfully</p>
